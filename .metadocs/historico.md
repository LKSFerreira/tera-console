...
- [Redesign do Hero & Spotlight](walkthrough/header_redesign.md): Reconstrução geométrica em blocos do Top Header para abranger espaços ociosos em Grid, escalonando fontes do projeto e transferindo a autoria do dev isolada do Rodapé nativo para a visão limpa.
