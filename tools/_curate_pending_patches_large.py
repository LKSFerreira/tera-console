...
def b133_01() -> None:
    ...
    L_pt = {
        ...
        "hl2i": [
            ...
            "UI de gauge de escudo em bosses.",
        ...
        "ui_t": "Boss Gauge — escudo",
        "ui_p": ["Pattern de escudo mostra ícone e valor restante na gauge."],
        "cap_ui": "Shield pattern na boss gauge.",
        "ot_t": "Outros",
...
def b132_01() -> None:
    ...
    L_pt = {
        ...
        "diff": [
            ...
            "Tier abaixo da HP gauge; bosses empowered; penalty na área de combate.",
            "Hard clear: Core Annihilation e Vanguard points extras.",
        ],
        "cap_gauge": "Tier na boss gauge.",
